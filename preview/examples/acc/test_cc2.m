...
tmin = 0;
tmax = 20;
param.thetamin = [sind(-30), sind(-10), sind(10)];
param.thetamax = [sind(-10), sind(10), sind(30)];
...
param2.thetamin = sind(-30);
param2.thetamax = sind(30);
...
X = Polyhedron('A', [1; -1], 'b', [32.0;-31.91]);
