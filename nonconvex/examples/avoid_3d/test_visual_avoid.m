...
B1 = [0,v_min,y_min,u_min,vy_min;
      h1, v_max,y_max,u_max,vy_max]';
B2 = [0,v_min,y_mid,u_min,vy_min;
    h3,v_max,y_max,u_max,vy_max]';
B3 = [h2,v_min,y_min,u_min,vy_min;
      h3,v_max,y_max,u_max,vy_max]';
B4 = [h2,0,y_min,u_min,vy_min;
      h_inf,v_max,y_mid,u_max,vy_max]';
...
%% visualization
hold on;
S0 = Polyhedron('lb',[-h_inf,0,y_min,u_min,vy_min],'ub',[h_inf,v_max,y_max,u_max,vy_max]);
S1 = S0.intersect(S1);
S2 = S0.intersect(S2);
S3 = S0.intersect(S3);
S4 = S0.intersect(S4);
...
plot(S4.projection([1,2,3]),'alpha',0.1)
xlabel("h")
ylabel("v_x")
zlabel("y")
