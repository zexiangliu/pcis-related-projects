...
constant_3d
[dyn,A,B,E,D,XU] = dyn_acc();

S0 = Polyhedron('lb',[-inf,v_min,u_min],'ub',[inf,v_max,u_max]);
S1 = S0.intersect(Polyhedron('lb',[h_min,-inf,-inf],'ub',[inf,inf,inf]));
S3 = S0.intersect(Polyhedron('lb',[-inf,-inf,-inf],'ub',[-h_min,inf,inf]));
S1.minHRep;
S3.minHRep;
S = [S1,S3];
